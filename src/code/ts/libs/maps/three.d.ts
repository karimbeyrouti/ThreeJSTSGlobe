...
//        faceUvs: Vector2[][];
	...
	export class DirectionalLight extends Light {
		...
		/**
		 * Default â€” [ -1.000, 0.990, 0.998 ].
		 */
		shadowCascadeNearZ: number[];

		/**
		 * Default â€” [ 0.990, 0.998, 1.000 ].
		 */
	...
	interface Math {
		 ...
		 *
		 * @param x â€” Value to be clamped.
		 * @param a â€” Minimum value
		 */
	...
	export class SphereGeometry extends Geometry {
		 ...
		 * @param segmentsWidth â€” number of horizontal segments. Minimum value is 3, and the default is 8.
		 * @param segmentsHeight â€” number of vertical segments. Minimum value is 2, and the default is 6.
