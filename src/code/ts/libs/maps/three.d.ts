...
module THREE {
    ...
    export class LensFlare extends Object3D {
        constructor(texture?: Texture, size?: number, distance?: number, blending?: Blending, color?: Color, opacity?: number);
    ...
    export class BloomPass {
        ...
        render ( renderer : Renderer, writeBuffer, readBuffer, delta, maskActive );
    ...
    export class EffectComposer {
        ...
        swapBuffers() : void;
        addPass( pass ) : void ;
        insertPass( pass , index : number ) : void ;
    ...
    export class TexturePass {
        ...
        constructor(texture : Texture , opacity : number );
        render ( renderer : Scene, camera : OrthographicCamera , readBuffer , delta : number );
        enabled : bool;
        needsSwap : bool;
    ...
    export class ShaderPass {
        ...
        render( renderer : Renderer , writeBuffer, readBuffer, delta ) : void ;

    }

    export class SavePass {
        constructor( shader : Shader , textureID );
        textureID : string ;
        uniforms : Uniforms;
        material : ShaderMaterial;
    ...
    export class RenderPass {
        constructor( scene : Scene, camera : Camera, overrideMaterial ? , clearColor ? , clearAlpha ? );
        scene : Scene;
        camera : Camera;
        overrideMaterial;
        clearColor;
    ...
    export class VerticalTiltShiftShader {
    ...
    export class UnpackDepthRGBAShader {

    }

    export class TriangleBlurShader {

    }

    export class SSAOShader {

    }

    export class SepiaShader {
    ...
    export class BleachBypassShader {
