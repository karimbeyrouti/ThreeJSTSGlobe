        ...
        (function (assets) {
            ...
            var Earth = (function (_super) {
                ...
                Earth.prototype.initClouds = function () {
                    this.cloudsTexture = THREE.ImageUtils.loadTexture(this.earthSettings.cloudsMap);
        ...
        (function (assets) {
            ...
            var Skybox = (function (_super) {
                ...
                Skybox.prototype.init = function () {
                    var urls = [
                        this.data.path + this.data.posx + this.data.format, 
                        this.data.path + this.data.negx + this.data.format, 
                        this.data.path + this.data.posy + this.data.format, 
                        this.data.path + this.data.negy + this.data.format, 
                        this.data.path + this.data.posz + this.data.format, 
                        this.data.path + this.data.negz + this.data.format
                    ];
        ...
        (function (assets) {
            ...
            var StarField = (function (_super) {
                ...
                StarField.prototype.init = function () {
                    ...
                    this.particleMat.color.setRGB(25, 25, 25);
                    this.particleMat.opacity = this.data.opacity;
...
(function (kurst) {
    (function (utils) {
        var JSUtils = (function () {
            function JSUtils() { }
            JSUtils.isFireFox = function isFireFox() {
                return (navigator.userAgent.search("Firefox") != -1);
            };
            JSUtils.isIE = function isIE() {
                return (navigator.appVersion.indexOf("MSIE") != -1);
            };
            JSUtils.getIEVersion = function getIEVersion() {
                if(JSUtils.isIE()) {
                    return parseFloat(navigator.appVersion.split("MSIE")[1]);
                }
                return -1;
            };
            JSUtils.isFlashEnabled = function isFlashEnabled() {
                if(JSUtils.isIE()) {
        ...
        (function (assets) {
            ...
            var Sun = (function (_super) {
                ...
                Sun.prototype.initSun = function () {
                    ...
                    var sunPhong = new THREE.MeshPhongMaterial({
                        map: sunTexture
                    });
        ...
        (function (assets) {
            var SkyGrid = (function (_super) {
                ...
                SkyGrid.prototype.initGrid = function () {
                    this.earthGridMat = new THREE.MeshBasicMaterial({
                        color: 0xffffff,
                        wireframe: true,
                        transparent: true,
                        opacity: 0.015
    ...
    (function (globe) {
        var GlobeView = (function (_super) {
            ...
            function GlobeView() {
                ...
                this.defaultMarker.material = new THREE.MeshBasicMaterial({
                    color: 0xffea00
                });
...
(function (kurst) {
    (function (utils) {
        var CookiesUtil = (function () {
            ...
            CookiesUtil.set = function set(name, value, options) {
                options = options || {
                };
                var def = [
            ...
            CookiesUtil.remove = function remove(name, options) {
                var opt2 = {
                };
            ...
            CookiesUtil.isRegExp = function isRegExp(o) {
                return '[object RegExp]' == Object.prototype.toString.call(o);
            };
            CookiesUtil.isDate = function isDate(o) {
                return '[object RegExp]' == Object.prototype.toString.call(o);
            };
            return CookiesUtil;
        })();
    ...
    (function (controller) {
        var GlobeController = (function (_super) {
            ...
            function GlobeController() {
                ...
                this.IPGeoCoderKEY = '3adfcad20627588be292388e8c0841afb958a2d63992e0d14b8de509b114b98a';
                this.detector = new kurst.threejs.Detector();
...
(function (Main) {
    var globeController;
    function start() {
        globeController = new apps.controller.GlobeController();
    }
    Main.start = start;
})(Main || (Main = {}));
